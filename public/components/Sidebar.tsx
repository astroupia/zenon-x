    ...
    const Sidebar: React.FC<SidebarProps> = ({ selectedTech, onSelectTech }) => {
        ...
        return (
            <div className={styles.sidebar}>
                ...
                <ul className={`${styles.projectList} ${isProjectsOpen ? styles.open : ''}`}>
                ...
                <div className={styles.findMe}>
                    ...
                    <div className={styles.socialLinks}>
                        <img src="/images/icons8-twitterx-500.png" alt="twitter" className={styles.socialIcon} />
                        <img src="/images/github.png" alt="GitHub" className={styles.socialIcon} />
                        <img src="/images/linkedin-icon.png" alt="LinkedIn" className={styles.socialIcon} />
                    </div>
                </div>
            </div>
        );
